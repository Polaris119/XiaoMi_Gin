...
func (con PassController) Login(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "polaris/pass/login.html", gin.H{
		"prevPage": prevPage,
	})
}
func (con PassController) RegisterStep1(c *gin.Context) {
	c.HTML(http.StatusOK, "polaris/pass/register_step1.html", gin.H{})
}
func (con PassController) RegisterStep2(c *gin.Context) {
	...
	if len(userTemp) > 0 {
		c.HTML(http.StatusOK, "polaris/pass/register_step2.html", gin.H{
...
func (con PassController) RegisterStep3(c *gin.Context) {
	...
	models.DB.Where("sign=?", sign).Find(&userTemp)
	if len(userTemp) > 0 {
		c.HTML(http.StatusOK, "polaris/pass/register_step3.html", gin.H{
			"smsCode": smsCode,
			"sign":    sign,
		})
	} else {
